...
def uploadproject(request):
    ...
    if request.method == 'POST':
        ...
        form = NewProfileForm()
    return render(request, 'uploadprojects.html', {"form": form})    
...
def userprofile(request):
    ...
    return render(request, 'profiles.html', {"my+projects": my_projects, "userprofile":userprofile})
...
def search_project(request):
    if 'project_name' in request.GET and request.GET["project_name"]:
        searched_term = request.GET.get("project_name")
...
def add_comment(request, proj_id):
    ...
    if request.method == 'POST':
        ...
        form = CommentForm()
    return render(request, 'commentform.html', {"form": form, "proj_id": proj_id})
